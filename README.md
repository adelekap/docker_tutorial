...
5. Navigate to http://0.0.0.0:4000/search/<your_fun_query>

6. Then try saving the result in the DB by navigating to http://0.0.0.0:4000/search/<your_fun_query>/store-result
